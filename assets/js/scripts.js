...
window.onload = function () {
  ...
  if (!$("body").hasClass("classic-setup")) {
    ...
    gsap.to([".loading-screen p", ".loading-screen .line"], {
      ease: "power3.in", duration: 0.6, opacity: 0, y: "100%", onComplete: function () {
        gsap.to(".loading-screen", {
          ease: "power3.inOut", duration: 1, opacity: 0, delay: 0.3, zIndex: -100, onComplete: function () {
...
function section_system() {
  ...
  function inital_setup() {
    ...
    gsap.to([".loading-screen p", ".loading-screen .line"], {
      ease: "power3.in", duration: 0.4, opacity: 0, y: "100%", onComplete: function () {
        gsap.to(".loading-screen", {
          ease: "power3.inOut", duration: 1, opacity: 0, zIndex: -100, delay: 0.3, onComplete: function () {
